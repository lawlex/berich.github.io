...
var Player = function() {
  ...
  function createSmallCard() {
    ...
    <div class="card border-dark mx-sm-1" style="font-size: 10px;">
                <div class="card border-dark shadow text-light bg-dark my-card" ><div class="text-light text-center mt-1"><h6 style="font-size: 11px;">Cars</h6></div></div>
                <div class="text-dark text-center pt-1 m-1">234</div>
            </div>
    ...
    */
    ...
    var _smallCard = `
          ...
          `;
    var _smallCard2 = `
              <div class="cardbs4 border-dark shadow text-light bg-dark my-card" ><div class="text-light text-center mt-1"><h6 style="font-size: 11px;"><span id="smallcardheader` + _smallCardId + `">` + _smallCardHeader + `</span></h6></div></div>
              <div class="text-dark text-center pt-1 m-1"><span id = "smallcardtext` + _smallCardId + `">` + _smallCardText + `</span></div>
      `;
