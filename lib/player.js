...
var Player = function() {
  ...
  */
  ...
  function createSmallCard() {
    ...
    */
    var _smallCard2 = `
              <div id="smallcardheadercontainer`+_smallCardId+`" class="card-small-body border-dark shadow text-light bg-dark my-card" ><div class="text-light text-center mt-1"><h6 style="font-size: 11px;"><span id="smallcardheader` + _smallCardId + `">` + _smallCardHeader + `</span></h6></div></div>
